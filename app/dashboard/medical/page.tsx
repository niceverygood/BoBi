...
function MedicalInfoContent() {
    ...
    const [authProvider, setAuthProvider] = useState('1'); // 카카오 기본
                    ...
                    <CardContent className="py-10 space-y-6">
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground text-sm">
                                <span className="font-semibold text-foreground">{selectedAuth?.icon} {selectedAuth?.name}</span> 앱에서
                                <br />인증을 완료해주세요
                            </p>
                        </div>
